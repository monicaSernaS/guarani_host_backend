 ...
 */
router.get("/bookings/:id", protect_1.protect, (0, checkRole_1.checkRole)("host"), hostBookingController_1.getHostBookingById);
 ...
 */
router.patch("/bookings/:id/status", protect_1.protect, (0, checkRole_1.checkRole)("host"), hostBookingController_1.updateHostBookingStatus);
// ====================== EXPORT OPERATIONS ======================
/**

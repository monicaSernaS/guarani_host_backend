 ...
 */
router.get("/bookings/:id", protect_1.protect, (0, checkRole_1.checkRole)("admin"), adminBookingController_1.getBookingById);
/**
 ...
 */
router.get("/bookings/filter/host/:hostId", protect_1.protect, (0, checkRole_1.checkRole)("admin"), adminBookingController_1.filterBookingsByHost);
// ====================== EXPORT OPERATIONS ======================
/**
 ...
 */
router.get("/bookings/export/pdf", protect_1.protect, (0, checkRole_1.checkRole)("admin"), adminBookingController_1.exportBookingsToPDF);

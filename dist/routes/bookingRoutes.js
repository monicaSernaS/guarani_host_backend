...
const upload = (0, multer_1.default)({
    ...
    fileFilter: (req, file, cb) => {
        ...
        if (file.mimetype.startsWith('image/')) {
            ...
            const error = new Error('Only image files are allowed for payment proof');
 ...
 */
router.post("/", protect_1.protect, (0, checkRole_1.checkRole)("user"), upload.fields([{ name: "paymentImage", maxCount: 5 }]), bookingController_1.createBooking);
/**
 ...
 */
router.get("/", protect_1.protect, (0, checkRole_1.checkRole)("user"), bookingController_1.getUserBookings);
/**
 ...
 */
router.get("/filter", protect_1.protect, (0, checkRole_1.checkRole)("user"), bookingController_1.filterUserBookings);
/**
 ...
 */
router.get("/:id", protect_1.protect, (0, checkRole_1.checkRole)("user"), bookingController_1.getUserBookingById);
// ====================== UPDATE OPERATIONS ======================
/**
 ...
 */
router.patch("/:id", protect_1.protect, (0, checkRole_1.checkRole)("user"), upload.fields([{ name: "paymentImage", maxCount: 5 }]), bookingController_1.updateUserBooking);
 ...
 */
router.delete("/:id", protect_1.protect, (0, checkRole_1.checkRole)("user"), bookingController_1.cancelUserBooking);
